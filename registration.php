...
<body style="background-color:#25b3cc">
	...
	<h1 class="animated heartBeat" align="center"><font color="#364045">Register Yourself</font> </h1><br><br>
	<div class="container">
		<form method="POST" action="db_reges.php" onsubmit="return validate()">
...
<center>
	...
	<h2 id="h"><font size="4px">click here to <font size="4px" color="darkblack"><a href="login.php" >LOGIN</a></font> if you are already registered</font></h2>
</center>
</div>
</form>
